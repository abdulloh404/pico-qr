                            ...
                            <div class="col-sm-12">
                                <div class="d-flex flex-column order-manage p-3 align-items-center mb-4">
                                    <div class="d-flex w-100">
                                        ...
                                        <a href="{{route('settings')}}" class="ml-auto text-primary font-w500">{{trans('layout.manage_settings')}}
                                            <i
                                                class="ti-angle-right ml-1"></i></a>
                                    </div>
                    ...
                    <div class="card-body p-4">
                        <div class="media ai-icon">
                            ...
                            <div class="media-body">
                                <h4 class="mb-0 text-black font-weight-bolder"><span class="counter ml-0">{{$countRestaurant}}</span></h4>
                ...
                <div class="widget-stat card">
                    <div class="card-body p-4">
                        <div class="media ai-icon">
                            ...
                            <div class="media-body">
                                <h4 class="mb-0 text-black font-weight-bolder"><span class="counter ml-0">{{$countItem}}</span></h4>
                ...
                <div class="widget-stat card">
                    <div class="card-body p-4">
                        <div class="media ai-icon">
                            ...
                            <div class="media-body">
                                <h4 class="mb-0 text-black font-weight-bolder"><span class="counter ml-0">{{$countPendingOrder}}</span>
                                </h4>
                    ...
                    <div class="widget-stat card">
                        <div class="card-body p-1">
                            <div class="media ai-icon mt-4">
                                ...
                                <div class="media-body">
                                    <h4 class="mb-0 text-black font-weight-bolder"><span class="counter ml-0">{{formatNumberWithCurrSymbol($countTotalIncome)}}</span></h4>
                ...
                <div class="widget-stat card">
                    <div class="card-body p-4">
                        <div class="media ai-icon">
                            ...
                            <div class="media-body">
                                <h4 class="mb-0 text-black font-weight-bolder"><span class="counter ml-0">{{$countPendingPlan}}</span></h4>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($pendingOrder->payment_status=='paid')
                                                <button class="btn btn-sm badge-success light">{{trans('layout.paid')}}</button>
                                            @else
