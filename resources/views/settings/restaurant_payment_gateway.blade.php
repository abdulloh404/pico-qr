...
<div id="v-pills-paytm" class="tab-pane fade">
    <div class="form-group">
        ...
        <select id="paytm_environment" name="paytm_environment"
                class="form-control">
            <option
                {{isset($rest_gateways_credentials->paytm_environment) && $rest_gateways_credentials->paytm_environment=='staging'?'selected':''}} value="staging">{{trans('layout.staging')}}</option>
            <option
                {{isset($rest_gateways_credentials->paytm_environment) && $rest_gateways_credentials->paytm_environment=='production'?'selected':''}}  value="production">{{trans('layout.production')}}</option>
        </select>
    </div>
