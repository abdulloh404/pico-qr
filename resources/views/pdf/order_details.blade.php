                    ...
                    <div style="width: 50%;margin-bottom: 20px;top:-20px" class="mt-4 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                        ...
                        @if($order->user)
                            ...
                            @if($order->type=='delivery')
                                <div>{{trans('layout.delivery_address')}}: {{$order->address}}</div>
                            @endif
                        @endif
                    </div>
                </div>
                    ...
                    <table class="table table-striped">
                        ...
                        @foreach($order->details as $key=>$details)
                            ...
                            <tr>
                                ...
                                <td>{{isset($order->restaurant->currency_symbol)?$order->restaurant->currency_symbol.' '.$details->item->price:formatNumberWithCurrSymbol($details->item->price)}}</td>
                                <td>{{isset($order->restaurant->currency_symbol)?$order->restaurant->currency_symbol.' '.$details->discount:formatNumberWithCurrSymbol($details->discount)}}</td>
                                <td>{{isset($order->restaurant->currency_symbol)?$order->restaurant->currency_symbol.' '.$details->tax_amount:formatNumberWithCurrSymbol($details->tax_amount)}}
                                <td>{{isset($order->restaurant->currency_symbol)?$order->restaurant->currency_symbol.' '.($details->total+$details->tax_amount):formatNumberWithCurrSymbol($details->total+$details->tax_amount)}}
                    ...
                    <div class="col-lg-4 col-sm-5 ml-auto">
                        <table class="table table-clear">
                            ...
                            <tr>
                                ...
                                <td class="right">{{isset($order->restaurant->currency_symbol)?$order->restaurant->currency_symbol.' '.$discount:formatNumberWithCurrSymbol($discount)}}</td>
                            </tr>
                            <tr>
                                <td class="left"><strong>{{trans('layout.total_tax')}}</strong></td>
                                <td class="right">{{isset($order->restaurant->currency_symbol)?$order->restaurant->currency_symbol.' '.$totalTax:formatNumberWithCurrSymbol($totalTax)}}</td>
                            </tr>
                            <tr>
                                <td class="left"><strong>{{trans('layout.grand_total')}}</strong></td>
                                <td class="right">{{isset($order->restaurant->currency_symbol)?$order->restaurant->currency_symbol.' '.$order->total_price:formatNumberWithCurrSymbol($order->total_price)}}</td>
                            </tr>
