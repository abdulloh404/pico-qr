...
<head>
    ...
    <!-- Website Title -->
    <title>PicoQR - {{trans('layout.privacy_policy')}}</title>
    ...
    <div class="container mt-5 pt-2">
        <div class="row">
            <div class="col-lg-12">
                ...
                <h2 class="h2-heading">{{trans('layout.privacy_policy')}}</h2>
            </div> <!-- end of col -->
        </div> <!-- end of row -->
        <div class="row" style="min-height: 400px">
            <div class="col-lg-12">
                {{isset(json_decode(get_settings('site_setting'))->privacy_policy)? json_decode(get_settings('site_setting'))->privacy_policy:''}}
            </div>
            <!-- end of col -->
        </div> <!-- end of row -->
    </div> <!-- end of container -->
