                        ...
                        <div class="row">
                            <div class="col-5">
                                <select name="plan_id" id="plan_id" class="form-control"
                                    ...
                                    <option
                                        {{request()->get('plan_id')=='all'?'selected':''}} value="all">{{trans('layout.all')}}</option>
                            ...
                            <div class="col-4">
                                <input value="{{request()->get('from_to_dates')}}" type="text" class="form-control"
                                       name="from_to_dates">
                            </div>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-info btn-xs"
                       href="{{route('report.index',['earning'=>'true'])}}">{{trans('layout.show_earning')}}</a>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-responsive-md">
                            ...
                            @foreach($userPlans as $userPlan)
                                <tr>
                                    ...
                                    <td>{{isset($userPlan->start_date)?formatDate($userPlan->start_date):''}}</td>
                                    <td>{{isset($userPlan->expired_date)?formatDate($userPlan->expired_date):''}}</td>
